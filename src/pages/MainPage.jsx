                ...
                <div className='w-full relative overflow-hidden'>
                    <div className='absolute gap-y-5 flex flex-col items-center justify-center w-full h-full z-20 -translate-y-60'>
                        ...
                        <div className='w-1/2 bg-white rounded-xl gap-x-5 px-5 py-4 flex items-center justify-center mt-28 border-gray-300 border-4'>
                            ...
                            <div className='h-16 w-16 bg-black rounded-xl flex items-center justify-center cursor-pointer'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 24 24" fill="none">
                                <path className='stroke-white' d="M15.7955 15.8111L21 21M18 10.5C18 14.6421 14.6421 18 10.5 18C6.35786 18 3 14.6421 3 10.5C3 6.35786 6.35786 3 10.5 3C14.6421 3 18 6.35786 18 10.5Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </div>
                        </div>
                    </div>
                ...
                <div className='flex justify-around py-10'>
                    <div className='bg-white hover:shadow-cars transition-all duraiton-300 rounded-xl w-72 h-80 flex flex-col justify-center items-center'>
                        ...
                        <div className='flex w-full h-1/2 flex-col items-center justify-around'>
                            ...
                            <h1 className='rounded-full font-semibold bg-gray-200 px-5 py-2 text-sm w-28 text-center text-gray-800 transition-all hover:bg-black hover:text-white duration-300'>18 машин</h1>
                        </div>
                    </div>
